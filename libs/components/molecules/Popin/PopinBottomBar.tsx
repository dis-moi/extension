...
import LogoBordeaux from 'libs/assets/img/contributors/logo-bordeaux.png';
import LogoColibri from 'libs/assets/img/contributors/logo-colibri-ecolo.png';
import LogoLeMonde from 'libs/assets/img/contributors/logo-le-monde.png';
import LogoLesInrocks from 'libs/assets/img/contributors/logo-les-inrocks.png';
import LogoMicode from 'libs/assets/img/contributors/logo-micode.png';
import LogoQueChoisir from 'libs/assets/img/contributors/logo-que-choisir.png';

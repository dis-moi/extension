...
import { Sidebar, TwoColumns } from 'src/components/atoms';
  ...
  if (connected) {
    return (
      <ProfileTabsContainer>
        <Tab to={t('path.profiles.contributors')}>
          {t('profiles:common.all')}
        </Tab>
        <Tab to={t('path.profiles.subscriptions')}>
          {t('profiles:menu.following')}
        </Tab>
      </ProfileTabsContainer>
    );
  }

...
import reducer, { BackgroundState } from 'apps/background/src/reducers';
import prefsReducer from 'apps/background/src/reducers/prefs.reducer';
import { isOnboardingRequired } from 'apps/background/src/selectors/index';

...
if (reversed == null) { reversed = false; }
	...
	// Calque_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("rgba(228,34,37,0.4)").beginStroke().moveTo(-114.5,13.3).lineTo(-114.5,-10.3).curveTo(-114.5,-11.6,-113.6,-12.4).curveTo(-112.7,-13.3,-111.5,-13.3).lineTo(111.5,-13.3).curveTo(112.7,-13.3,113.6,-12.4).curveTo(114.5,-11.6,114.5,-10.3).lineTo(114.5,13.3).closePath();
...
if (reversed == null) { reversed = false; }
	...
	// Calque_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("rgba(40,58,124,0.8)").beginStroke().moveTo(-219.8,23.4).lineTo(-219.8,-23.4).lineTo(219.8,-23.4).lineTo(219.8,23.4).closePath();
...
if (reversed == null) { reversed = false; }
	...
	// Calque_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#283A7C").beginStroke().moveTo(-10.1,1.4).lineTo(-10.1,-1.4).lineTo(10,-1.4).lineTo(10,1.4).closePath();
...
if (reversed == null) { reversed = false; }
	...
	// Calque_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#283A7C").beginStroke().moveTo(-13.2,1.4).lineTo(-13.2,-1.4).lineTo(13.2,-1.4).lineTo(13.2,1.4).closePath();
...
(lib.LeMemeEnLocalCercle = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Calque_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#2B3C78").beginStroke().moveTo(-35.1,83.1).curveTo(-51.3,76.3,-63.8,63.8).curveTo(-76.3,51.3,-83.1,35.1).curveTo(-90.2,18.3,-90.2,-0).curveTo(-90.2,-18.4,-83.1,-35.1).curveTo(-76.3,-51.3,-63.8,-63.8).curveTo(-51.3,-76.3,-35.1,-83.1).curveTo(-18.4,-90.2,-0,-90.2).curveTo(18.3,-90.2,35.1,-83.1).curveTo(51.3,-76.3,63.8,-63.8).curveTo(76.3,-51.3,83.1,-35.1).curveTo(90.2,-18.4,90.2,-0).curveTo(90.2,18.3,83.1,35.1).curveTo(76.3,51.3,63.8,63.8).curveTo(51.3,76.3,35.1,83.1).curveTo(18.3,90.2,-0,90.2).curveTo(-18.4,90.2,-35.1,83.1).closePath().moveTo(-31,-73.3).curveTo(-45.2,-67.2,-56.2,-56.2).curveTo(-67.2,-45.2,-73.3,-31).curveTo(-79.5,-16.2,-79.5,-0).curveTo(-79.5,16.2,-73.3,30.9).curveTo(-67.2,45.2,-56.2,56.2).curveTo(-45.2,67.2,-31,73.3).curveTo(-16.2,79.5,-0,79.5).curveTo(16.2,79.5,30.9,73.3).curveTo(45.2,67.2,56.2,56.2).curveTo(67.2,45.2,73.3,30.9).curveTo(79.5,16.2,79.5,-0).curveTo(79.5,-16.2,73.3,-31).curveTo(67.2,-45.2,56.2,-56.2).curveTo(45.2,-67.2,30.9,-73.3).curveTo(16.2,-79.5,-0,-79.5).curveTo(-16.2,-79.5,-31,-73.3).closePath();
...
}).prototype = getMCSymbolPrototype(lib.LeMemeEnLocalCercle, new cjs.Rectangle(-90.2,-90.2,180.5,180.5), null);
...
if (reversed == null) { reversed = false; }
	...
	// Calque_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#F0B745").beginStroke().moveTo(-45,26.6).curveTo(-43.8,9.3,-36.4,-6.2).curveTo(-29.1,-21.3,-16.9,-32.8).lineTo(45,32.8).closePath();
	this.shape.setTransform(45,32.8);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Path, new cjs.Rectangle(0,0,90,65.6), null);
...
if (reversed == null) { reversed = false; }
	...
	var instance_9Filter_2 = new cjs.ColorFilter(0,0,0,1,228,34,37,0);
	...
	var instance_10Filter_3 = new cjs.ColorFilter(0,0,0,1,228,34,37,0);
	...
	var instance_11Filter_4 = new cjs.ColorFilter(0,0,0,1,228,34,37,0);
	...
	var instance_12Filter_5 = new cjs.ColorFilter(0,0,0,1,228,34,37,0);
	...
	var instance_13Filter_6 = new cjs.ColorFilter(0,0,0,1,228,34,37,0);
	...
	var instance_14Filter_7 = new cjs.ColorFilter(0,0,0,1,228,34,37,0);
	...
	var instance_15Filter_8 = new cjs.ColorFilter(0,0,0,1,228,34,37,0);
	...
	var instance_16Filter_9 = new cjs.ColorFilter(0,0,0,1,228,34,37,0);
	...
	var instance_17Filter_10 = new cjs.ColorFilter(0,0,0,1,228,34,37,0);
...
if (reversed == null) { reversed = false; }
	...
	// FlashAICB
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("rgba(40,58,124,0.898)").beginStroke().moveTo(-42.7,114.3).curveTo(-47.6,114.3,-51.1,110.8).curveTo(-54.6,107.3,-54.6,102.3).lineTo(-54.6,-114.3).lineTo(54.6,-114.3).lineTo(54.6,114.3).closePath();
...
(lib.LeMemeEnLocalCoq = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Calque_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#FFFFFF").beginStroke().moveTo(6.1,10.1).curveTo(5.3,9.8,5,9).curveTo(4.7,8.2,5,7.5).curveTo(7,2.7,6.4,-1.4).curveTo(5.9,-5,3.7,-5.9).curveTo(1.6,-6.8,-1.3,-4.7).curveTo(-4.7,-2.3,-6.7,2.5).curveTo(-7.1,3.3,-7.8,3.6).curveTo(-8.6,3.9,-9.4,3.5).curveTo(-10.1,3.2,-10.4,2.5).curveTo(-10.8,1.7,-10.4,0.9).curveTo(-8,-4.9,-3.7,-8).curveTo(1,-11.4,5.3,-9.6).curveTo(9.5,-7.8,10.4,-2).curveTo(11.2,3.2,8.7,9).curveTo(8.2,10.2,6.8,10.2).closePath();
	this.shape.setTransform(-1.3405,-20.5615);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#2B3C78").beginStroke().moveTo(-22,22).curveTo(-31.1,12.9,-31.1,-0).curveTo(-31.1,-12.9,-22,-22).curveTo(-12.9,-31.1,-0,-31.1).curveTo(12.9,-31.1,22,-22).curveTo(31.1,-12.9,31.1,-0).curveTo(31.1,12.9,22,22).curveTo(12.9,31.1,-0,31.1).curveTo(-12.9,31.1,-22,22).closePath();
	this.shape_1.setTransform(9.225,-10.325);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#D23931").beginStroke().moveTo(-12.4,20.9).curveTo(-23,13.2,-32.4,5.2).lineTo(-34.3,1.9).curveTo(-36.5,-2.2,-37.8,-6.5).curveTo(-41.8,-20.3,-35.4,-30.8).curveTo(-29.9,-27.4,-23.9,-24.8).curveTo(-11.9,-19.6,-9.4,-23.1).curveTo(-3.9,-30.8,-0.3,-34.5).lineTo(18.4,-23.1).curveTo(15.7,-16.9,13,-12.2).curveTo(17.7,-15.1,21.9,-16.8).curveTo(24,-17.7,25.2,-18).lineTo(35.4,-0.7).curveTo(30.9,4,25.9,7.2).curveTo(29.8,8,35,10.5).curveTo(37.6,11.8,39.4,12.9).lineTo(35.6,31.1).curveTo(32.3,31.3,28,31.7).curveTo(19.5,32.6,14.5,34.3).curveTo(13.9,34.5,13,34.5).curveTo(6.4,34.5,-12.4,20.9).closePath();
	this.shape_2.setTransform(24.9439,-41.4401);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#D23931").beginStroke().moveTo(-6.8,6.9).curveTo(-9.7,4,-9.7,-0).curveTo(-9.7,-4,-6.8,-6.9).curveTo(-4,-9.7,-0,-9.7).curveTo(4,-9.7,6.8,-6.9).curveTo(9.7,-4,9.7,-0).curveTo(9.7,2.2,8.6,4.3).curveTo(7.4,6.8,5.1,8.2).curveTo(2.8,9.7,-0,9.7).curveTo(-4,9.7,-6.8,6.9).closePath();
	this.shape_3.setTransform(59.85,-19.875);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#D23931").beginStroke().moveTo(-1.8,10.3).curveTo(-6.1,9.5,-8.5,6).curveTo(-11,2.4,-10.3,-1.8).curveTo(-9.5,-6.1,-6,-8.5).curveTo(-2.4,-11,1.8,-10.3).curveTo(6.1,-9.5,8.5,-6).curveTo(11,-2.4,10.3,1.8).curveTo(9.5,6.1,6,8.5).curveTo(3.2,10.4,0.1,10.4).curveTo(-0.8,10.4,-1.8,10.3).closePath();
	this.shape_4.setTransform(52.725,-49.275);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#D23931").beginStroke().moveTo(-7.8,7.8).curveTo(-11.1,4.6,-11.1,-0).curveTo(-11.1,-4.6,-7.8,-7.8).curveTo(-4.6,-11.1,0,-11.1).curveTo(4.6,-11.1,7.9,-7.8).curveTo(11.1,-4.6,11.1,-0).curveTo(11.1,4.6,7.9,7.8).curveTo(4.6,11.1,0,11.1).curveTo(-4.6,11.1,-7.8,7.8).closePath();
	this.shape_5.setTransform(33.1,-68.75);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#D23931").beginStroke().moveTo(-10,10).curveTo(-14.1,5.8,-14.1,-0).curveTo(-14.1,-5.9,-10,-10).curveTo(-5.8,-14.1,-0,-14.1).curveTo(5.8,-14.1,10,-10).curveTo(14.1,-5.9,14.1,-0).curveTo(14.1,5.8,10,10).curveTo(5.8,14.1,-0,14.1).curveTo(-5.8,14.1,-10,10).closePath();
	this.shape_6.setTransform(1.375,-64.475);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#2B3C78").beginStroke().moveTo(-33.1,44.8).curveTo(-46.4,20.1,-46.4,-8).curveTo(-46.4,-26.3,-40.5,-43.5).curveTo(-33,-45.1,-25.3,-45.1).curveTo(0.2,-45.1,20.2,-29.5).curveTo(39.9,-14.2,46.3,9.8).curveTo(33.8,26.2,15.3,35.5).curveTo(-3.8,45.1,-25.3,45.1).curveTo(-29.5,45.1,-33.1,44.8).closePath();
	this.shape_7.setTransform(34.5,34.775);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#D23931").beginStroke().moveTo(-12.9,4).curveTo(-8.7,-7.6,3.3,-14.3).lineTo(14.7,9.2).lineTo(-14.7,14.3).curveTo(-15,9.8,-12.9,4).closePath();
	this.shape_8.setTransform(-16.6187,25.375);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("#D23931").beginStroke().moveTo(-14.3,14.4).curveTo(-20.2,8.4,-20.3,0).curveTo(-20.2,-8.4,-14.3,-14.3).curveTo(-8.4,-20.3,-0,-20.2).curveTo(8.4,-20.3,14.4,-14.3).curveTo(20.2,-8.4,20.2,0).curveTo(20.2,8.4,14.4,14.4).curveTo(8.4,20.2,-0,20.3).curveTo(-8.4,20.2,-14.3,14.4).closePath();
	this.shape_9.setTransform(-11.05,39.65);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.beginFill("#D23931").beginStroke().moveTo(-12.5,12.5).curveTo(-17.7,7.3,-17.7,0).curveTo(-17.7,-7.3,-12.5,-12.5).curveTo(-7.3,-17.7,-0,-17.7).curveTo(7.3,-17.7,12.5,-12.5).curveTo(17.7,-7.3,17.7,0).curveTo(17.7,7.3,12.5,12.5).curveTo(7.3,17.7,-0,17.7).curveTo(-7.3,17.7,-12.5,12.5).closePath();
	this.shape_10.setTransform(-19.425,7.525);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.beginFill("#F0B745").beginStroke().moveTo(-10.9,16.4).curveTo(-11.9,16.4,-12.5,15.7).curveTo(-13.2,15.1,-13.2,14.1).curveTo(-13.2,12.5,-11.6,12).lineTo(2.1,5).lineTo(-3.3,-14.3).curveTo(-3.5,-14.8,-3.5,-15.2).curveTo(-3.5,-16.1,-2.8,-16.7).curveTo(-2.2,-17.4,-1.2,-17.4).curveTo(-0.5,-17.4,0.2,-16.8).lineTo(13.2,-3.1).lineTo(3.5,17.4).closePath();
	this.shape_11.setTransform(-25.25,-29.825);

	this.instance = new lib.Path();
	this.instance.setTransform(-35.8,-43.15,1,1,0,0,0,45,32.8);
...
}).prototype = getMCSymbolPrototype(lib.LeMemeEnLocalCoq, new cjs.Rectangle(-80.8,-79.8,161.7,159.7), null);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.moveTo(-3.3,3.3).curveTo(-4.6,2,-4.6,-0).curveTo(-4.6,-1.9,-3.3,-3.3).curveTo(-1.9,-4.6,-0,-4.6).curveTo(2,-4.6,3.3,-3.3).curveTo(4.6,-1.9,4.6,-0).curveTo(4.6,2,3.3,3.3).curveTo(2,4.7,-0,4.7).curveTo(-1.9,4.7,-3.3,3.3).closePath();
	mask.setTransform(6.25,5.6);

	// Calque_3
	this.LeMemeEnLocalCoq = new lib.LeMemeEnLocalCoq();
	this.LeMemeEnLocalCoq.name = "LeMemeEnLocalCoq";
	this.LeMemeEnLocalCoq.setTransform(7.9,7.8,0.0977,0.0977);

	var maskedShapeInstanceList = [this.LeMemeEnLocalCoq];

	for(var shapedInstanceItr = 0; shapedInstanceItr < maskedShapeInstanceList.length; shapedInstanceItr++) {
		maskedShapeInstanceList[shapedInstanceItr].mask = mask;
	}

	this.timeline.addTween(cjs.Tween.get(this.LeMemeEnLocalCoq).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.ClipGroup, new cjs.Rectangle(1.6,1,9.3,9.3), null);
...
if (reversed == null) { reversed = false; }
	...
	// FlashAICB
	this.LeMemeEnLocalCercle = new lib.LeMemeEnLocalCercle();
	this.LeMemeEnLocalCercle.name = "LeMemeEnLocalCercle";
	this.LeMemeEnLocalCercle.setTransform(11.15,11.4,0.1268,0.1268,0,0,0,1.2,1.2);

	this.instance = new lib.ClipGroup();
	this.instance.setTransform(15.05,16.6,2.3131,2.3131,0,0,0,7.9,7.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.LeMemeEnLocalCercle}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.extension, new cjs.Rectangle(-3.2,-1.5,36.6,36.1), null);
...
}).prototype = getMCSymbolPrototype(lib.bubble, new cjs.Rectangle(-93.1,0,250.7,131.5), null);


// stage content:
(lib.lmelwebsitecoveranimation = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.actionFrames = [0,35,38,110,122,125,197,209,212,279];
	// timeline functions:
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(35).call(this.frame_35).wait(3).call(this.frame_38).wait(72).call(this.frame_110).wait(12).call(this.frame_122).wait(3).call(this.frame_125).wait(72).call(this.frame_197).wait(12).call(this.frame_209).wait(3).call(this.frame_212).wait(67).call(this.frame_279).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.traitQuiSouligneIci},{t:this.traitQuiSouligneLa}]}).wait(280));
	...
	this.timeline.addTween(cjs.Tween.get(this.bubble1).wait(35).to({_off:false},0).to({y:108.05,alpha:1},3).to({_off:true},72).wait(170));
	...
	this.timeline.addTween(cjs.Tween.get(this.bubble2).wait(122).to({_off:false},0).to({y:108.05,alpha:1},3).to({_off:true},72).wait(83));
	...
	this.timeline.addTween(cjs.Tween.get(this.bubble3).wait(209).to({_off:false},0).to({y:108.05,alpha:1},3).wait(68));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(23).to({_off:false},0).to({scaleX:1,x:219.9},6).to({alpha:0},3).wait(78).to({scaleX:0.0271,x:6.05,alpha:1},0).to({scaleX:1,x:219.9},6).to({alpha:0},3).wait(78).to({scaleX:0.0271,x:6.05,alpha:1},0).to({scaleX:1,x:219.9},6).to({alpha:0},3).wait(74));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:true},29).wait(174).to({_off:false,alpha:0},0).to({alpha:0.8008},3).wait(74));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(29).to({_off:false},0).to({alpha:0.8008},3).to({_off:true},78).wait(170));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(116).to({_off:false},0).to({alpha:0.8008},3).to({_off:true},78).wait(83));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(4).to({_off:false},0).to({regX:122.8,scaleX:0.3583,x:60.2},5).wait(4).to({regX:122.6,scaleX:1,x:138.85},10).wait(67).to({regX:122.7,scaleX:0.0375,x:20.85},0).to({regX:122.8,scaleX:0.3583,x:60.2},3).wait(8).to({regX:122.6,scaleX:0.6589,x:97.05},8).wait(69).to({regX:122.7,scaleX:0.0375,x:20.85},0).to({regX:122.8,scaleX:0.3583,x:60.2},5).wait(3).to({regX:122.7,scaleX:1.3207,x:178.3},11).wait(83));

...
export interface CoverSectionAnimatedLeftProps {
  className?: string;
}

const CoverSection = styled((props: CoverSectionAnimatedLeftProps) => {
  return (
    <Section id="cover" {...props}>
      ...
      <GridContainer>
        <StyledGridRow>
          ...
          <StyledGridCol2>
            <PrimaryHeadline>
              Ce que les sites web ne disent pas, vous le saurez.
            </PrimaryHeadline>
            <SecondaryHeadline>

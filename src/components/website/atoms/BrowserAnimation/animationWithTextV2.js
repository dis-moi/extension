(function(cjs, an) {
  ...
  (lib.bubbleText = function(mode, startPosition, loop, reversed) {
    ...
    // Calque_1
    this.text = new cjs.Text('LALALA\nLALALA', "bold 30px 'Lato'", '#0C52B4');
    this.text.lineHeight = 29;
    this.text.lineWidth = 207;
    this.text.parent = this;
    this.text.setTransform(-120.45, 1.05);
    ...
    lib.bubbleText,
    new cjs.Rectangle(-122.4, -0.9, 211.4, 75),
    null
  );
  ...
  // stage content:
  (lib.RECUPERE_dismoiwebsitecoveranimationwithTextv2 = function(
    mode,
    startPosition,
    loop,
    reversed
    ...
    this.frame_35 = function() {
      ...
      this.currentTextSize = this.currentWords.length > 30 ? 16 : 20;
      ...
      console.log('dom', dom_overlay_container);
      setTimeout(function() {
  ...
  // library properties:
  lib.properties = {
    id: '5ED811F4CA4D4A1082E6963D6B77B251',
    width: 440,
    height: 300,
    fps: 24,
    color: '#000000',
  ...
  an.compositions['5ED811F4CA4D4A1082E6963D6B77B251'] = {
    getStage: function() {

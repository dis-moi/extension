...
// stage content:
(lib.dismoiwebsitecoveranimationvar1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(35).to({_off:false},0).to({y:108.05,alpha:1},3).wait(42));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(23).to({_off:false},0).to({scaleX:1,x:219.9},6).to({alpha:0},3).wait(48));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2}]}).to({state:[{t:this.instance_3}]},29).to({state:[{t:this.instance_3}]},3).wait(48));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(29).to({_off:false},0).to({alpha:0.8008},3).wait(48));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(4).to({_off:false},0).to({regX:122.8,scaleX:0.3583,x:60.2},5).wait(4).to({regX:122.6,scaleX:1,x:138.85},10).wait(57));

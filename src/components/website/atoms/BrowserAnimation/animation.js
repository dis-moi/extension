(function(cjs, an) {
  ...
  (lib.bubbleText = function(mode, startPosition, loop, reversed) {
    ...
    // Calque_1
    this.bubbleTextBloc = new cjs.Text('LALALA', "bold 30px 'Lato'", '#0C52B4');
    this.bubbleTextBloc.name = 'bubbleTextBloc';
    this.bubbleTextBloc.lineHeight = 37;
    this.bubbleTextBloc.lineWidth = 207;
    this.bubbleTextBloc.parent = this;
    this.bubbleTextBloc.setTransform(-120.45, 0.05);
    ...
    lib.bubbleText,
    new cjs.Rectangle(-122.4, -1.9, 211.4, 75),
    null
  );
  ...
  (lib.bubbleFormat = function(mode, startPosition, loop, reversed) {
    ...
    this.shape.graphics
      ...
      .beginStroke()
      .moveTo(-112.3, 60.1)
      .curveTo(-116, 60.1, -118.6, 57.5)
      .curveTo(-121.2, 54.9, -121.2, 51.2)
      .lineTo(-121.3, -35.8)
      .curveTo(-121.3, -39.5, -118.7, -42.1)
      .curveTo(-116, -44.7, -112.4, -44.7)
      .lineTo(67.6, -44.6)
      .lineTo(83.2, -60.2)
      .lineTo(98.7, -44.6)
      .lineTo(112.3, -44.6)
      .curveTo(116, -44.6, 118.6, -42)
      .curveTo(121.2, -39.4, 121.2, -35.7)
      .lineTo(121.3, 51.3)
      .curveTo(121.3, 55, 118.7, 57.6)
      .curveTo(116.1, 60.2, 112.4, 60.2)
      .closePath()
      .moveTo(-115.1, -38.5)
      .curveTo(-116.3, -37.4, -116.3, -35.8)
      .lineTo(-116.2, 51.2)
      .curveTo(-116.2, 52.9, -115.1, 54)
      .curveTo(-113.9, 55.2, -112.3, 55.2)
      .lineTo(112.4, 55.2)
      .curveTo(114, 55.2, 115.1, 54)
      .curveTo(116.3, 52.9, 116.3, 51.3)
      .lineTo(116.2, -35.7)
      .curveTo(116.2, -37.4, 115.1, -38.5)
      .curveTo(113.9, -39.7, 112.3, -39.7)
      .lineTo(96.7, -39.7)
      .lineTo(83.2, -53.2)
      .lineTo(69.7, -39.7)
      .lineTo(-112.4, -39.7)
      .curveTo(-114, -39.7, -115.1, -38.5)
      .closePath();
    this.shape.setTransform(36.125, 60.2);
    ...
    this.shape_1.graphics
      ...
      .beginStroke()
      .moveTo(-111.5, 58.9)
      .curveTo(-115.1, 58.9, -117.8, 56.3)
      .curveTo(-120.4, 53.7, -120.4, 50)
      .lineTo(-120.4, -34.6)
      .curveTo(-120.4, -38.2, -117.8, -40.9)
      .curveTo(-115.1, -43.5, -111.5, -43.5)
      .lineTo(66.8, -43.4)
      .lineTo(82.3, -59)
      .lineTo(97.9, -43.4)
      .lineTo(111.5, -43.4)
      .curveTo(115.2, -43.4, 117.8, -40.8)
      .curveTo(120.4, -38.2, 120.4, -34.5)
      .lineTo(120.4, 50.1)
      .curveTo(120.4, 53.8, 117.8, 56.4)
      .curveTo(115.2, 59, 111.5, 59)
      .closePath();
    this.shape_1.setTransform(36.975, 58.975);
    ...
    lib.bubbleFormat,
    new cjs.Rectangle(-85.1, 0, 242.5, 120.4),
    null
  );
  ...
  (lib.bubble = function(mode, startPosition, loop, reversed) {
    ...
    this.bubbleText.setTransform(85.65, 55.9, 1, 1, 0, 0, 0, 31.7, 22.4);
  ...
  (lib.dismoiwebsitecoveranimation = function(
    ...
    this.actionFrames = [0, 35, 92, 149, 189];
    // timeline functions:
    ...
    this.frame_35 = function() {
      if (this.looped === 1) {
        this.bubble1.bubbleText.bubbleTextBloc.text = this.words[0];
      } else if (this.looped === 2) {
        this.bubble1.bubbleText.bubbleTextBloc.text = this.words[3];
      } else if (this.looped === 3) {
        this.bubble1.bubbleText.bubbleTextBloc.text = this.words[6];
      }
    };
    this.frame_92 = function() {
      if (this.looped === 1) {
        this.bubble2.bubbleText.bubbleTextBloc.text = this.words[1];
      } else if (this.looped === 2) {
        this.bubble2.bubbleText.bubbleTextBloc.text = this.words[4];
      } else if (this.looped === 3) {
        this.bubble2.bubbleText.bubbleTextBloc.text = this.words[7];
      }
    };
    this.frame_149 = function() {
      if (this.looped === 1) {
        this.bubble3.bubbleText.bubbleTextBloc.text = this.words[2];
      } else if (this.looped === 2) {
        this.bubble3.bubbleText.bubbleTextBloc.text = this.words[5];
      } else if (this.looped === 3) {
        this.bubble3.bubbleText.bubbleTextBloc.text = this.words[8];
      }
    };

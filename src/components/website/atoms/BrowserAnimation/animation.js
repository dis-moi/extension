...
if (reversed == null) { reversed = false; }
	...
	// Calque_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#2E559C").beginStroke().moveTo(-27.5,4).curveTo(-28.8,4,-29.6,3.1).curveTo(-30.5,2.3,-30.5,1).lineTo(-30.5,-1).curveTo(-30.5,-2.2,-29.6,-3.1).curveTo(-28.8,-4,-27.5,-4).lineTo(27.5,-4).curveTo(28.8,-4,29.6,-3.1).curveTo(30.5,-2.2,30.5,-1).lineTo(30.5,1).curveTo(30.5,2.3,29.6,3.1).curveTo(28.8,4,27.5,4).closePath();
	this.shape.setTransform(30.525,40.75);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#2E559C").beginStroke().moveTo(-25.7,4).curveTo(-26.9,4,-27.8,3.1).curveTo(-28.7,2.2,-28.6,1).lineTo(-28.6,-1).curveTo(-28.7,-2.2,-27.8,-3.1).curveTo(-26.9,-4,-25.7,-4).lineTo(25.6,-4).curveTo(26.9,-4,27.8,-3.1).curveTo(28.6,-2.2,28.7,-1).lineTo(28.7,1).curveTo(28.6,2.2,27.8,3.1).curveTo(26.9,4,25.6,4).closePath();
	this.shape_1.setTransform(28.65,28.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#2E559C").beginStroke().moveTo(-28.7,4).curveTo(-29.9,4,-30.8,3.1).curveTo(-31.7,2.3,-31.7,1).lineTo(-31.7,-1).curveTo(-31.7,-2.2,-30.8,-3.1).curveTo(-29.9,-4,-28.7,-4).lineTo(28.7,-4).curveTo(29.9,-4,30.8,-3.1).curveTo(31.7,-2.2,31.7,-1).lineTo(31.7,1).curveTo(31.7,2.3,30.8,3.1).curveTo(29.9,4,28.7,4).closePath();
	this.shape_2.setTransform(31.675,16.25);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#2E559C").beginStroke().moveTo(-20.9,4).curveTo(-22.1,4,-23,3.1).curveTo(-23.9,2.2,-23.9,1).lineTo(-23.9,-1).curveTo(-23.9,-2.2,-23,-3.1).curveTo(-22.1,-4,-20.9,-4).lineTo(20.9,-4).curveTo(22.1,-4,23,-3.1).curveTo(23.9,-2.2,23.9,-1).lineTo(23.9,1).curveTo(23.9,2.2,23,3.1).curveTo(22.1,4,20.9,4).closePath();
...
}).prototype = getMCSymbolPrototype(lib.bubbleText3, new cjs.Rectangle(0,0,63.4,44.8), null);
...
if (reversed == null) { reversed = false; }
	...
	// Calque_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#2E559C").beginStroke().moveTo(-17.2,4).curveTo(-18.4,4,-19.3,3.1).curveTo(-20.2,2.3,-20.1,1).lineTo(-20.1,-1).curveTo(-20.2,-2.2,-19.3,-3.1).curveTo(-18.4,-4,-17.2,-4).lineTo(17.1,-4).curveTo(18.4,-4,19.3,-3.1).curveTo(20.1,-2.2,20.2,-1).lineTo(20.2,1).curveTo(20.1,2.3,19.3,3.1).curveTo(18.4,4,17.1,4).closePath();
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#2E559C").beginStroke().moveTo(-24.8,4).curveTo(-26,4,-26.9,3.1).curveTo(-27.8,2.2,-27.8,1).lineTo(-27.8,-1).curveTo(-27.8,-2.2,-26.9,-3.1).curveTo(-26,-4,-24.8,-4).lineTo(24.8,-4).curveTo(26,-4,26.9,-3.1).curveTo(27.8,-2.2,27.8,-1).lineTo(27.8,1).curveTo(27.8,2.2,26.9,3.1).curveTo(26,4,24.8,4).closePath();
	this.shape_2.setTransform(27.775,16.25);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#2E559C").beginStroke().moveTo(-27.3,4).curveTo(-28.6,4,-29.4,3.1).curveTo(-30.3,2.2,-30.3,1).lineTo(-30.3,-1).curveTo(-30.3,-2.2,-29.4,-3.1).curveTo(-28.6,-4,-27.3,-4).lineTo(27.3,-4).curveTo(28.6,-4,29.4,-3.1).curveTo(30.3,-2.2,30.3,-1).lineTo(30.3,1).curveTo(30.3,2.2,29.4,3.1).curveTo(28.6,4,27.3,4).closePath();
...
}).prototype = getMCSymbolPrototype(lib.bubbleText2, new cjs.Rectangle(0,0,63.4,44.8), null);
...
if (reversed == null) { reversed = false; }
	...
	// Calque_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#2E559C").beginStroke().moveTo(-21.6,4).curveTo(-22.8,4,-23.7,3.1).curveTo(-24.6,2.3,-24.6,1).lineTo(-24.6,-1).curveTo(-24.6,-2.3,-23.7,-3.1).curveTo(-22.8,-4,-21.6,-4).lineTo(21.6,-4).curveTo(22.8,-4,23.7,-3.1).curveTo(24.6,-2.3,24.6,-1).lineTo(24.6,1).curveTo(24.6,2.3,23.7,3.1).curveTo(22.8,4,21.6,4).closePath();
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#2E559C").beginStroke().moveTo(-13.4,4).curveTo(-14.6,4,-15.5,3.1).curveTo(-16.4,2.2,-16.4,1).lineTo(-16.4,-1).curveTo(-16.4,-2.2,-15.5,-3.1).curveTo(-14.6,-4,-13.4,-4).lineTo(13.4,-4).curveTo(14.7,-4,15.5,-3.1).curveTo(16.4,-2.2,16.4,-1).lineTo(16.4,1).curveTo(16.4,2.2,15.5,3.1).curveTo(14.7,4,13.4,4).closePath();
	this.shape_2.setTransform(16.4,16.25);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#2E559C").beginStroke().moveTo(-28.7,4).curveTo(-29.9,4,-30.8,3.1).curveTo(-31.7,2.2,-31.7,1).lineTo(-31.7,-1).curveTo(-31.7,-2.2,-30.8,-3.1).curveTo(-29.9,-4,-28.7,-4).lineTo(28.7,-4).curveTo(29.9,-4,30.8,-3.1).curveTo(31.7,-2.2,31.7,-1).lineTo(31.7,1).curveTo(31.7,2.2,30.8,3.1).curveTo(29.9,4,28.7,4).closePath();
...
}).prototype = getMCSymbolPrototype(lib.bubbleText1, new cjs.Rectangle(0,0,63.4,44.8), null);
...
if (reversed == null) { reversed = false; }
	...
	// FlashAICB
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3,32.5).curveTo(-4.2,32.5,-5,31.6).curveTo(-5.9,30.7,-5.9,29.5).lineTo(-5.9,26.6).lineTo(5.9,26.6).lineTo(5.9,29.5).curveTo(5.9,30.7,5.1,31.6).curveTo(4.2,32.5,3,32.5).closePath().moveTo(-5.9,23.6).curveTo(-7.1,23.6,-8,22.7).curveTo(-8.9,21.9,-8.9,20.7).lineTo(-8.9,15.3).curveTo(-12.9,13,-15.3,9).curveTo(-17.7,4.8,-17.7,0).curveTo(-17.7,-7.4,-12.5,-12.6).curveTo(-7.3,-17.8,0,-17.8).curveTo(7.3,-17.8,12.5,-12.6).curveTo(17.7,-7.4,17.7,0).curveTo(17.7,4.8,15.3,9).curveTo(12.9,13,8.9,15.3).lineTo(8.9,20.7).curveTo(8.9,21.9,8,22.7).curveTo(7.1,23.6,5.9,23.6).closePath().moveTo(24.1,2.9).curveTo(23.6,2.9,23.6,2.5).lineTo(23.6,-2.5).curveTo(23.6,-3,24.1,-3).lineTo(32,-3).curveTo(32.5,-3,32.5,-2.5).lineTo(32.5,2.5).curveTo(32.5,2.9,32,2.9).closePath().moveTo(-32,2.9).curveTo(-32.5,2.9,-32.5,2.5).lineTo(-32.5,-2.5).curveTo(-32.5,-3,-32,-3).lineTo(-24.1,-3).curveTo(-23.6,-3,-23.6,-2.5).lineTo(-23.6,2.5).curveTo(-23.6,2.9,-24.1,2.9).closePath().moveTo(18.5,-15).lineTo(15,-18.5).curveTo(14.6,-18.9,15,-19.2).lineTo(20.5,-24.7).curveTo(20.9,-25.2,21.2,-24.7).lineTo(24.7,-21.3).curveTo(25.1,-20.9,24.7,-20.6).lineTo(19.2,-15).curveTo(19.1,-15,19.1,-14.9).curveTo(19,-14.9,19,-14.9).curveTo(19,-14.8,18.9,-14.8).curveTo(18.9,-14.8,18.8,-14.8).curveTo(18.8,-14.8,18.7,-14.8).curveTo(18.7,-14.8,18.7,-14.9).curveTo(18.6,-14.9,18.6,-14.9).curveTo(18.5,-15,18.5,-15).closePath().moveTo(-19.2,-15).lineTo(-24.7,-20.6).curveTo(-25.1,-20.9,-24.7,-21.3).lineTo(-21.3,-24.7).curveTo(-20.9,-25.2,-20.6,-24.7).lineTo(-15,-19.2).curveTo(-14.6,-18.9,-15,-18.5).lineTo(-18.5,-15).curveTo(-18.5,-15,-18.6,-14.9).curveTo(-18.6,-14.9,-18.6,-14.9).curveTo(-18.7,-14.8,-18.7,-14.8).curveTo(-18.8,-14.8,-18.8,-14.8).curveTo(-18.9,-14.8,-18.9,-14.8).curveTo(-19,-14.8,-19,-14.9).curveTo(-19,-14.9,-19.1,-14.9).curveTo(-19.1,-15,-19.2,-15).closePath().moveTo(-2.5,-23.6).curveTo(-3,-23.6,-3,-24.2).lineTo(-3,-32.1).curveTo(-3,-32.5,-2.5,-32.5).lineTo(2.5,-32.5).curveTo(3,-32.5,3,-32.1).lineTo(3,-24.2).curveTo(3,-23.6,2.5,-23.6).closePath();
	this.shape.setTransform(24.9875,25,0.5,0.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#2E559D").beginStroke().moveTo(-35.3,35.3).curveTo(-50,20.7,-50,0).curveTo(-50,-20.8,-35.3,-35.3).curveTo(-20.8,-50,0,-50).curveTo(20.7,-50,35.3,-35.3).curveTo(50,-20.8,50,0).curveTo(50,20.7,35.3,35.3).curveTo(20.7,50,0,50).curveTo(-20.8,50,-35.3,35.3).closePath();
...
}).prototype = getMCSymbolPrototype(lib.bubblePicto3, new cjs.Rectangle(0,0,50,50), null);
...
if (reversed == null) { reversed = false; }
	...
	// FlashAICB
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-10.9,30).curveTo(-12,30,-12.9,29.1).curveTo(-13.6,28.4,-13.6,27.2).lineTo(-13.6,21.8).curveTo(-13.6,20.7,-12.9,19.9).curveTo(-12,19,-10.9,19).lineTo(-8.2,19).lineTo(-8.2,2.7).lineTo(-10.9,2.7).curveTo(-12.1,2.7,-12.9,1.9).curveTo(-13.6,1,-13.6,0).lineTo(-13.6,-5.5).curveTo(-13.6,-6.5,-12.9,-7.4).curveTo(-12.1,-8.2,-10.9,-8.2).lineTo(5.5,-8.2).curveTo(6.6,-8.2,7.4,-7.4).curveTo(8.2,-6.5,8.2,-5.5).lineTo(8.2,19).lineTo(10.9,19).curveTo(12,19,12.9,19.9).curveTo(13.7,20.7,13.7,21.8).lineTo(13.7,27.2).curveTo(13.7,28.4,12.9,29.1).curveTo(12,30,10.9,30).closePath().moveTo(-5.4,-16.4).curveTo(-6.6,-16.4,-7.3,-17.2).curveTo(-8.2,-18,-8.2,-19.1).lineTo(-8.2,-27.3).curveTo(-8.2,-28.4,-7.3,-29.2).curveTo(-6.6,-30,-5.4,-30).lineTo(5.5,-30).curveTo(6.6,-30,7.4,-29.2).curveTo(8.2,-28.4,8.2,-27.3).lineTo(8.2,-19.1).curveTo(8.2,-18,7.4,-17.2).curveTo(6.6,-16.4,5.5,-16.4).closePath();
	this.shape.setTransform(25.525,25.0122,0.5,0.5002);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#2E559D").beginStroke().moveTo(-37.7,50).curveTo(-42.7,50,-46.4,46.4).curveTo(-50,42.8,-50,37.7).lineTo(-50,-37.7).curveTo(-50,-42.8,-46.4,-46.4).curveTo(-42.7,-50,-37.7,-50).lineTo(37.7,-50).curveTo(42.8,-50,46.4,-46.4).curveTo(50,-42.8,50,-37.7).lineTo(50,37.7).curveTo(50,42.8,46.4,46.4).curveTo(42.8,50,37.7,50).closePath();
...
}).prototype = getMCSymbolPrototype(lib.bubblePicto2, new cjs.Rectangle(0,0,50,50), null);
...
if (reversed == null) { reversed = false; }
	...
	// FlashAICB
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-6,27.9).curveTo(-6.8,27.9,-7.4,27.3).curveTo(-8,26.7,-8,25.9).lineTo(-8,14).curveTo(-8,13.2,-7.4,12.6).curveTo(-6.8,12,-6,12).lineTo(6,12).curveTo(6.8,12,7.4,12.6).curveTo(8,13.2,8,14).lineTo(8,25.9).curveTo(8,26.7,7.4,27.3).curveTo(6.8,27.9,6,27.9).closePath().moveTo(-5.8,4).curveTo(-6.7,4,-7.3,3.6).curveTo(-7.9,3.2,-7.9,2.6).lineTo(-9,-25.9).curveTo(-9,-26.8,-8.4,-27.2).curveTo(-7.5,-27.9,-6.9,-27.9).lineTo(6.8,-27.9).curveTo(7.5,-27.9,8.3,-27.2).curveTo(9,-26.8,9,-26).lineTo(7.8,2.6).curveTo(7.7,3.2,7.2,3.6).curveTo(6.6,4,5.7,4).closePath();
	this.shape.setTransform(25.0125,24.9997,0.5,0.5002);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#2E559D").beginStroke().moveTo(-1.9,49.2).lineTo(-12.6,38.9).lineTo(-27.3,41).curveTo(-28.4,41.1,-29.4,40.5).curveTo(-30.3,39.8,-30.5,38.7).lineTo(-33.1,24).lineTo(-46.2,17.1).curveTo(-47.2,16.5,-47.6,15.5).curveTo(-47.9,14.4,-47.4,13.3).lineTo(-40.8,-0).lineTo(-47.4,-13.3).curveTo(-47.9,-14.4,-47.6,-15.5).curveTo(-47.2,-16.5,-46.2,-17.1).lineTo(-33.1,-24).lineTo(-30.5,-38.6).curveTo(-30.3,-39.8,-29.4,-40.5).curveTo(-28.4,-41.1,-27.3,-41).lineTo(-12.6,-38.9).lineTo(-1.9,-49.2).curveTo(-1.1,-50,0,-50).curveTo(1.2,-50,2,-49.2).lineTo(12.6,-38.9).lineTo(27.3,-41).curveTo(28.5,-41.1,29.4,-40.5).curveTo(30.4,-39.8,30.5,-38.6).lineTo(33.1,-24).lineTo(46.2,-17.1).curveTo(47.2,-16.5,47.6,-15.5).curveTo(47.9,-14.4,47.4,-13.3).lineTo(40.9,-0).lineTo(47.4,13.3).curveTo(47.9,14.4,47.6,15.5).curveTo(47.2,16.5,46.2,17.1).lineTo(33.1,24).lineTo(30.5,38.7).curveTo(30.4,39.8,29.4,40.5).curveTo(28.5,41.1,27.3,41).lineTo(12.6,38.9).lineTo(2,49.2).curveTo(1.2,50,0,50).curveTo(-1.1,50,-1.9,49.2).closePath();
	this.shape_1.setTransform(25,24.9997,0.5,0.5002);
...
}).prototype = getMCSymbolPrototype(lib.bubblePicto1, new cjs.Rectangle(1.2,0,47.699999999999996,50), null);
...
if (reversed == null) { reversed = false; }
	...
	// Calque_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#2E559C").beginStroke().moveTo(-69.8,48.6).curveTo(-73.4,48.6,-76.1,46).curveTo(-78.7,43.4,-78.7,39.7).lineTo(-78.7,-24.2).curveTo(-78.7,-27.8,-76.1,-30.5).curveTo(-73.4,-33.1,-69.8,-33.1).lineTo(25.1,-33.1).lineTo(40.6,-48.6).lineTo(56.2,-33.1).lineTo(69.8,-33.1).curveTo(73.5,-33.1,76.1,-30.5).curveTo(78.7,-27.9,78.7,-24.2).lineTo(78.7,39.7).curveTo(78.7,43.4,76.1,46).curveTo(73.5,48.6,69.8,48.6).closePath().moveTo(-72.5,-26.9).curveTo(-73.7,-25.8,-73.7,-24.2).lineTo(-73.7,39.7).curveTo(-73.7,41.3,-72.5,42.5).curveTo(-71.4,43.6,-69.8,43.6).lineTo(69.8,43.6).curveTo(71.4,43.6,72.5,42.5).curveTo(73.7,41.3,73.7,39.7).lineTo(73.7,-24.2).curveTo(73.7,-25.8,72.5,-26.9).curveTo(71.4,-28.1,69.8,-28.1).lineTo(54.1,-28.1).lineTo(40.6,-41.6).lineTo(27.2,-28.1).lineTo(-69.8,-28.1).curveTo(-71.4,-28.1,-72.5,-26.9).closePath();
	this.shape.setTransform(78.675,48.625);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-69.8,48.6).curveTo(-73.4,48.6,-76.1,46).curveTo(-78.7,43.4,-78.7,39.7).lineTo(-78.7,-24.2).curveTo(-78.7,-27.8,-76.1,-30.5).curveTo(-73.4,-33.1,-69.8,-33.1).lineTo(25.1,-33.1).lineTo(40.6,-48.6).lineTo(56.2,-33.1).lineTo(69.8,-33.1).curveTo(73.5,-33.1,76.1,-30.5).curveTo(78.7,-27.9,78.7,-24.2).lineTo(78.7,39.7).curveTo(78.7,43.4,76.1,46).curveTo(73.5,48.6,69.8,48.6).closePath();
...
}).prototype = getMCSymbolPrototype(lib.bubbleFormat, new cjs.Rectangle(0,0,157.4,97.3), null);
...
}).prototype = getMCSymbolPrototype(lib.bubble3, new cjs.Rectangle(0,0,157.4,97.3), null);
...
}).prototype = getMCSymbolPrototype(lib.bubble2, new cjs.Rectangle(0,0,157.4,97.3), null);
...
}).prototype = getMCSymbolPrototype(lib.bubble1, new cjs.Rectangle(0,0,157.4,97.3), null);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(23).call(this.frame_23).wait(9).call(this.frame_32).wait(48).call(this.frame_80).wait(9).call(this.frame_89).wait(48).call(this.frame_137).wait(9).call(this.frame_146).wait(43).call(this.frame_189).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(35).to({_off:false},0).to({y:108.05,alpha:1},3).to({_off:true},42).wait(110));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(92).to({_off:false},0).to({y:108.05,alpha:1},3).to({_off:true},42).wait(53));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(149).to({_off:false},0).to({y:108.05,alpha:1},3).wait(38));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(23).to({_off:false},0).to({scaleX:1,x:219.9},6).to({alpha:0},3).wait(48).to({scaleX:0.0271,x:6.05,alpha:1},0).to({scaleX:1,x:219.9},6).to({alpha:0},3).wait(48).to({scaleX:0.0271,x:6.05,alpha:1},0).to({scaleX:1,x:219.9},6).to({alpha:0},3).wait(44));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({_off:true},29).wait(114).to({_off:false,alpha:0},0).to({alpha:0.8008},3).wait(44));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(29).to({_off:false},0).to({alpha:0.8008},3).to({_off:true},48).wait(110));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(86).to({_off:false},0).to({alpha:0.8008},3).to({_off:true},48).wait(53));

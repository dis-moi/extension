...
const TabButton = styled(
  ...
  button {
    ...
    &.blue {
      ...
      &.active {
        color: ${props => props.theme.websiteLMEL.primaryColorDarker};
    ...
    &.greenDarker {
      ...
      &.active {
        color: ${props => props.theme.websiteLMEL.secondaryColorDarker};
        background-color: rgba(236, 145, 25, 0.1);
        &:hover {
          color: white;
        }
      }
    ...
    &.orange {
      ...
      &.active {
        color: ${props => props.theme.websiteLMEL.activeColorDarker};
  ...
  button:first-of-type {
    border-radius: ${props => props.theme.websiteLMEL.radiusSmall}
      ${props => props.theme.websiteLMEL.radiusSmall} 0 0;
    @media (min-width: ${props => props.theme.tabletWidth}) {
      border-radius: ${props => props.theme.websiteLMEL.radiusSmall} 0 0
        ${props => props.theme.websiteLMEL.radiusSmall};
    }
  }
  button:last-of-type {
    border-radius: 0 0 ${props => props.theme.websiteLMEL.radiusSmall}
      ${props => props.theme.websiteLMEL.radiusSmall};
    @media (min-width: ${props => props.theme.tabletWidth}) {
      border-radius: 0 ${props => props.theme.websiteLMEL.radiusSmall}
        ${props => props.theme.websiteLMEL.radiusSmall} 0;
    }
  }
`;
